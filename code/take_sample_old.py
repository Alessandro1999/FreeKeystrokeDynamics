...
def _take_sample(sentence: str = "") -> List[Tuple[str, float, float]]:
    ...
    records: List[keyboard.KeyboardEvent] = keyboard.record(until="enter") #TODO implement it manually
    sentence_written = input()
    print(f"You have written {sentence_written}")
